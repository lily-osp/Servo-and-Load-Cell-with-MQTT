...
#define WLAN_PASS       "angga..."         // Your password

//aio config
#define AIO_SERVER      "io.adafruit.com"
#define AIO_SERVERPORT  1883                   // use 8883 for SSL
#define AIO_USERNAME    "Azzar"
#define AIO_KEY         "aio_CUJr96zpqfq6e2Z92Z3d0jctuzof"
...
//mqtt publish
Adafruit_MQTT_Publish beban   = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/beban");
